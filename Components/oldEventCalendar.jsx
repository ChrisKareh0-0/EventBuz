  ...
  return (
    <div id="scheduler_here" className="dhx_cal_container" style={{ width: '100%', height: '600px'}}>
      <div className="dhx_cal_navline">
        ...
        <div className="dhx_cal_tab" name="day_tab" style={{ left: 16 }}></div>
        <div className="dhx_cal_tab" name="week_tab" style={{ left: 103 }}></div>
        <div className="dhx_cal_tab" name="month_tab"  style={{ left: 192 }}></div>
      </div>
